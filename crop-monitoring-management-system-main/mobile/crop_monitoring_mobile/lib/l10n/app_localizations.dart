...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'New Cane Observation'**
  String get newObservation;

  /// No description provided for @captureRealTimeData.
  ///
  /// In en, this message translates to:
  /// **'Capture real-time cane data'**
  String get captureRealTimeData;

  /// No description provided for @observationHistory.
  ///
  /// In en, this message translates to:
  /// **'Sugarcane History'**
  String get observationHistory;

  /// No description provided for @viewManageRecords.
  ///
  /// In en, this message translates to:
  /// **'View and manage cane records'**
  String get viewManageRecords;
