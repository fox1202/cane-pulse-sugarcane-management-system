...
function normalizeSugarcaneMonitoringRow(row: Record<string, unknown>): SugarcaneMonitoringRecord {
    ...
    return {
        ...
        crop_vigor: toNullableString(row.crop_vigor) ?? undefined,
        canopy_cover: toNullableNumber(row.canopy_cover) ?? undefined,
